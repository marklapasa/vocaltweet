...
import vocaltweet.lapasa.net.vocaltweet.fragments.LoginFragment;
import vocaltweet.lapasa.net.vocaltweet.fragments.NavigationDrawerFragment;
import vocaltweet.lapasa.net.vocaltweet.fragments.TweetsListFragment;
import vocaltweet.lapasa.net.vocaltweet.models.TweetsModel;


public class MainActivity extends Activity
        implements NavigationDrawerFragment.NavigationDrawerCallbacks, ITweetModelActivity, TextToSpeech.OnInitListener
{
...
//        fragmentManager.beginTransaction().replace(R.id.container, PlaceholderFragment.newInstance(position + 1)).commit();
    ...
    /**
     * Main fragment that displays many tweets
     */
    private void loadTweetsListFragment()
    {
